						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">Student My Page</h3>
								</div>
								<div class="card-body">
										<div class="form-floating mb-3">
											<input class="form-control" name="m_id" id="inputEmail"
												type="text" placeholder="name@example.com" value="${loginDTO.m_id}" readonly /> <label
												for="inputEmail">ID</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" name="m_password"
												id="inputPassword" type="text" placeholder="Password" value="${loginDTO.m_password}" readonly />
											<label for="inputPassword">Password</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" name="m_name"
												id="m_name" type="text" placeholder="name" value="${loginDTO.m_name}" readonly />
											<label for="m_name">Name</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" name="m_email"
												id="m_email" type="text" placeholder="email" value="${loginDTO.m_email}" readonly />
											<label for="inputPassword">Email</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" name="m_phone"
												id="m_phone" type="text" placeholder="phone" value="${loginDTO.m_phone}" readonly />
											<label for="m_phone">Phone</label>
										</div>
										<div
											class="d-flex align-items-center justify-content-between mt-4 mb-0">
											<a class="btn btn-primary" href="/member/update">Data Update</a>
											<a class="btn btn-primary" href="/member/s_myanswer?m_id=${loginDTO.m_id}">My Score</a>
										</div>
								</div>
							</div>
						</div>
