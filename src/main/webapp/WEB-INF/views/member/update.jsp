...
<script>
	...
	function pwch2() {
		const id = document.getElementById('inputEmail').value;
						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">Data Update</h3>
								</div>
								<div class="card-body">
									<form action="update" method="post" name="update_form2">
										<div class="form-floating mb-3">
											<input class="form-control" name="m_id" id="inputEmail"
												type="text" placeholder="name@example.com"
												value="${loginDTO.m_id}" readonly /> <label
									...
									<div
										...
										<a class="btn btn-primary" onclick="pwch2()">Data Update</a>
									</div>
								</div>
							</div>
						</div>
