						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">Admin Page</h3>
								</div>
								<div class="card-body">
										<div
											class="d-flex align-items-center justify-content-between mt-4 mb-0">
											<a class="btn btn-primary" href="/member/m_findAll">All Member</a>
											<a class="btn btn-primary" href="/member/q_findAll">All Question</a>
										</div>
