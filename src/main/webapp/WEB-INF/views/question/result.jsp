						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">Result</h3>
								</div>
								<div class="card-body">Score : ${score}</div>
							</div>
						</div>
					</div>
				</div>

				<c:if test="${falseList != null}">
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-5">
								<div class="card shadow-lg border-0 rounded-lg mt-5">
									<div class="card-header">
										<h3 class="text-center font-weight-light my-4">wrong
											answer</h3>
									</div>
									<div class="card-body">
							...
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								...
								<div class="card-body">
									<form name="review_form" id="review_form"
										action="/answer/review" method="post">
										<input type="hidden" name="s_number"
											value="${falseList[1].s_number}">
										...
										<div class="form-floating mb-3">
											<fieldset>
												...
												<input type="radio" name="r_score" value="5.0" id="score1"><label
													...
													value="4.0" id="score2"><label for="score2">⭐</label>
												<input type="radio" name="r_score" value="3.0" id="score3"><label
													for="score3">⭐</label> <input type="radio" name="r_score"
													value="2.0" id="score4"><label for="score4">⭐</label>
												<input type="radio" name="r_score" value="1.0" id="score5"><label
													for="score5">⭐</label> <br>
											</fieldset>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" name="r_contents" id="r_contents"
												type="text" plaseholder="c" /> <label for="r_contents">Contents</label>
										</div>
										<div
											class="d-flex align-items-center justify-content-between mt-4 mb-0">
											<a class="btn btn-primary" onclick="review_btn()">Make</a>
										</div>
									</form>
								</div>
							</div>
