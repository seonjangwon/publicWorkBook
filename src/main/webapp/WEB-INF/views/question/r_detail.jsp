			...
			<main>
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> Review
					</div>
					<div class="card-body">
						<table id="datatablesSimple">
							<thead>
								<tr>
									<th>Number</th>
									<th>Writer</th>
									<th>Score ( avg  <c:choose>
											<c:when test="${avg == 0}">0</c:when>
											<c:when test="${avg == 1}">⭐</c:when>
											<c:when test="${avg == 2}">⭐⭐</c:when>
											<c:when test="${avg == 3}">⭐⭐⭐</c:when>
											<c:when test="${avg == 4}">⭐⭐⭐⭐	</c:when>
